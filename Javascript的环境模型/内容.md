...
[Environment.js](https://github.com/Iplaylf2/JavaScript-Articles/blob/master/Javascript的环境模型/Environment.js)的主要意义是让人熟悉环境模型的概念，作为代码没有什么使用价值。  
[这里](https://github.com/Iplaylf2/JavaScript-Articles/blob/master/Javascript的环境模型/Environment.detail.js)有一个通过console展示环境模型运作步骤的代码，以及它的[demo](https://github.com/Iplaylf2/JavaScript-Articles/blob/master/Javascript的环境模型/模拟环境模型的demo.js)。与Environment.js还有一个区别是增添了函数名用来命名环境。
